...
@Component({
  selector: 'app-ComunView',
  templateUrl: './ComunView.component.html',
  styleUrls: ['./ComunView.component.css']

})
export class ComunViewComponent implements OnInit, AfterViewInit {
